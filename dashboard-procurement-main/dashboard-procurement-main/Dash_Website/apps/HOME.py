...
layout = html.Div(children=[
    ...
    html.Div([
        html.Div([
            NavLink(
                html.Img(src=app.get_asset_url('procurement-icon.png'), className="img__style"), 
        ...
        html.Div([
            NavLink(
                html.Img(src=app.get_asset_url('raw-material-2-logo.png'), className="img__style"), 
        ...
        html.Div([
            NavLink(
                html.Img(src=app.get_asset_url('clearance-icon.png'), className="img__style"), 
        ...
        html.Div([
            NavLink(
                html.Img(src=app.get_asset_url('indirect-mkt-icon.png'), className="img__style"), 
        ...
        html.Div([
            NavLink(
                html.Img(src=app.get_asset_url('indirect-icon.png'), className="img__style"), 
